# 🤖 AGENTS.md - mathematicalFoundation

## 🎯 **Mission Scope**
**Layer**: 2 | **Category**: formal-verification | **Difficulty**: {{difficulty}}/10
**Mathematical Foundation**: polynomial-algebra, hopf-fibration, identity-chain | **AAL Dimensions**: 0, 1, 9
...
- [ ] **Norm Preservation**: {{normPreservingRequirements}}
...
aal/index.ts
aal/types.ts
cryptography/SECURITY.md
cryptography/bhargava-solver.ts
cryptography/commit-signature.ts
cryptography/constant-time.ts
cryptography/cryptography.test.ts
cryptography/cubic-dh.ts
cryptography/cubic-keygen.ts
cryptography/cubic-signature.ts
```
...
npm run test:math mathematicalFoundation

# Performance benchmarks
npm run benchmark mathematicalFoundation
```
...
npm run perf mathematicalFoundation

# Step 4: Integration testing
npm run integration mathematicalFoundation
```
