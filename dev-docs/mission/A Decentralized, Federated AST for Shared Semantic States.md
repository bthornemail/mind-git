---
id: "mind-git:development:a-decentralized--federated-ast-for-shared-semantic-states"
title: "CanvasL"
type: ["development"]
...
_Executive Summary & Technical Architecture_
...
This is a _structural tree_, not an evaluation tree. The distinction matters: we represent and validate structure, we do not compute truth.
...
When contradictions are detected in a shared subtree, CanvasL propagates **diagnostic messages** upstream and suggests local edits. It does _not_ force changes. This is exactly like type errors, lints, or failing tests. **Nothing is compelled. Everything is suggested.**
...
> _"We model meaning the way Git models code. We validate structure the way compilers validate syntax. We federate state the way ActivityPub federates posts."_
