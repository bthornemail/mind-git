...
### **File Structure**
- `dev-docs/Affine/Schema.md`
- `dev-docs/Affine/Scheme.md`
- `dev-docs/Affine/Sink.md`
- `dev-docs/Affine/Source.md`
- `dev-docs/Affine/Store.md`
- `dev-docs/Affine/Structure.md`
- `dev-docs/Affine/Syntax.md`
...
> **Component ID**: kernel:dev-docs-Affine  
